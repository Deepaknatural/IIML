...
training_data <- read.csv('C:\\Deepak\\IIML\\RF\\Train_data.csv')

testing_data <- read.csv('C:\\Deepak\\IIML\\RF\\Test_data.csv')
...
continuous_col <- setdiff(names(train_data),cat_col)
